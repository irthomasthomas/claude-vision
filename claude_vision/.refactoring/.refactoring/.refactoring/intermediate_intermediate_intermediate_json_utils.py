Thank you for providing the context and the refactored code. I understand that you want to further streamline and improve the CLI structure based on the redesign plan. Here's an updated version of the code that incorporates the requested changes:
